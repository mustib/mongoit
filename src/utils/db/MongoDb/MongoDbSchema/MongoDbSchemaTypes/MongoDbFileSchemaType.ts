...
class MongoDbFileSchemaType extends AbstractMongoDbSchemaType<FileSchemaTypes> {
  ...
  async validateFieldValue(
    ...
    const validated =
      await AbstractMongoDbSchemaType.prototype.validateFieldValue.bind(this)(
        _value,
        options
      );
...
export default MongoDbFileSchemaType;
